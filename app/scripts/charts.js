$(function () {
  ...
  function countByTimeByEmotion(elements){
    return R.reduce(byTimeByEmotion, {"sad":{}, "meh":{}, "happy": {}}, elements);
  }
  ...
  function buildSplineGraph(rawData){
    var processedData = countByTimeByEmotion(rawData);
    console.log(processedData);
  }
  ...
  function buildLineGraph(container) {
    $(container).highcharts({
        ...
        series: [{
            ...
            data: [
                [Date.UTC(1970, 9, 21,1), 0],
                [Date.UTC(1970, 10, 4,4), 0.28],
                [Date.UTC(1970, 10, 9,2), 0.25],
